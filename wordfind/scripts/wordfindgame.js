...
(function (document, $, wordfind) {
  'use strict';
  $("div").click(function() { top.keypadTime = 0; }); //reset keypadTimer ever time user clicks on a <div>; user is returned to main menu
  ...
  */
    ...
    */
    var drawPuzzle = function (el, puzzle) {
      ...
      //prevent user from being able to select/copy/move words in wordlist
      document.getElementById("words").addEventListener("mousedown", function(event){
  ...
  var WordFindGame = function (puzzleEl, options) {
    ...
    */
    var startTurn = function () {
      top.keypadTime = 0; //reset global keypadTimer so that user is not returned to Main Menu
    ...
    var endTurn = function () {
      ...
      for (var i = 0, len = wordList.length; i < len; i++) {
        ...
        if (wordList.length === 0) {
          ...
          console.log("You solved the puzzle. Great job!");
          //do other end of game tasks here
        }
      }
